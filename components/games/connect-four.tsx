    ...
    <Card className="bg-gray-900/50 border-yellow-500/20 mx-2 sm:mx-0">
      ...
      <CardContent>
        <div className="space-y-3 sm:space-y-2">
          {/* Column buttons */}
          <div className="grid grid-cols-7 gap-1 mb-4 transform scale-50 md:scale-100 origin-center">
          ...
          <div className="bg-blue-900/30 p-3 sm:p-4 rounded-lg">
            <div className="flex flex-col gap-1 mx-auto max-w-fit transform scale-50 md:scale-100 origin-center">
